...
public class ProjectRestController {
	...
	/*
	 * @PostMapping("/project/projectReload") public Map<String, Object>
	 * projectReload(Issue issue) { int pNum = issue.getpNum(); int tnum =
	 * issue.gettNum(); Map<String, Object> data = new HashMap<String, Object>();
	 * Task task = new Task(); task.setpNum(pNum); data.put("projectJson",
	 * pSvc.getProject(issue.getpNum())); data.put("taskJson",
	 * tSvc.getTaskList(task)); data.put("issueJson", iSvc.getIssueList(issue));
	 * return data;
	 * 
	 * }
	 */
